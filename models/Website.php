...
class Website extends BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['company_country'],'required','when'=>function($model){return ($model->company_city);},
                'whenClient'=> $this->clientSideValidatorCondition('company_city', '', false)],
            [['company_city'],'required','when'=>function($model){return ($model->company_street_address);},
                'whenClient'=> $this->clientSideValidatorCondition('company_street_address', '', false)],
            [['company_street_address'],'required','when'=>function($model){return ($model->company_postal_code);},
                'whenClient'=> $this->clientSideValidatorCondition('company_postal_code', '', false)],
