...
namespace intermundia\yiicms\modules\system\models\search;
...
/**
 * SystemLogSearch represents the model behind the search form about `intermundia\yiicms\models\SystemLog`.
 */
