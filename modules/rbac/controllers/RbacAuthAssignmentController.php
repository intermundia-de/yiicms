...
namespace intermundia\yiicms\modules\rbac\controllers;

use intermundia\yiicms\web\BackendController;
use Yii;
use intermundia\yiicms\modules\rbac\models\RbacAuthAssignment;
 ...
 */
class RbacAuthAssignmentController extends BackendController
{
